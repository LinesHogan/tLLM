...
class PerRequestBenchmarkCompatUnitTest(unittest.TestCase):
    ...
    def test_model_bank_slots_follow_stable_effective_capacity_when_unspecified(self) -> None:
        self.assertEqual(bench._resolve_model_bank_slots(0, effective_batch_cap=64, prompt_count=8), 64)
